...
a=list(set(df['category']))
a
things_to_plot = a[0:]#['Email', 'General Software Development']
...
Next steps:
-what is wrong with the packages i'm trying to import
-what is the fastest way to segment data in python?
-figure out how to make bar charts in python
- 
'''

#http://blog.yhathq.com/posts/aggregating-and-plotting-time-series-in-python.html
#next segment the data based on the time
